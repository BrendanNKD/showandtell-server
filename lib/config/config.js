...
const { AWS_COGNITO_USER_POOL_ID, AWS_COGNITO_CLIENT_ID, AWS_COGNITO_IDENTITY_POOL_ID, AWS_REGION, AWS_COGNITO_CLIENT_NAME, HCAPTCHA_SECRET_KEY, HCAPTCHA_SITE_KEY, ENVIRONMENT, DOMAIN, LOG_PATH, LOG_INFO_FILE, LOG_ERROR_FILE, LOG_ALL_FILE, REPLICATE_API_TOKEN, ORGANIZATION_KEY, OPENAI_API_KEY, APIURl, CLOUD_NAME, API_KEY, API_SECRET, } = process.env;
const config = {
